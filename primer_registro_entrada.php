<?php
    ...
    $insert_persona ="INSERT INTO persona(dni, nombre, apellido, telefono) 
    VALUES ($dni_valor,$nombre_valor,$apellido_valor,$telefono_valor)";

    mysqli_query($conn,$insert_persona);
